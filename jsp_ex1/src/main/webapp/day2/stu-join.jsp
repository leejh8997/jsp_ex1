...
<body>
	...
	<% 
	String sql = "SELECT STU_NO FROM STUDENT";
...
<script>
	...
	function fnCheck(){
		...
		let left = (screen.availWidth - 300) / 2;
		let popup = window.open("id-check.jsp?stuNo="+stu.stuNo.value, '중복체크', `width=300,height=300,left=${left},top=${top}`);
